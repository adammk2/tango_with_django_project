...
def register(request):
    ...
    # the registeration was successful.
...
def user_login(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            if user.is_active:
                ...
                # and send them back to homepage.
                login(request, user)
    ...
    # Likely a HTTP GET.
        ...
        # No context variables to pass, hence blank dictionary object
...
def visitor_cookie_handler(request):
    ...
    # Use COOKIES.get() function to obtain visits cookie.
    # If cookie exists, value casted to int.
    # If cookie doesn't exist, default value 1 is used.
